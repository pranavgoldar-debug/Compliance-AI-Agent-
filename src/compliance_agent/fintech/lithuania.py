...
def _build() -> list[FintechFiling]:
    return [
        ...
        FintechFiling(
            ...
            area="VAT",
            form_name="FR0600 (PVM deklaracija)",
            authority="VMI",
            frequency="Monthly (quarterly / bi-annual for small taxpayers)",
            due_date_rule="By the 25th of the following month.",
            payment_due="Same date as filing.",
            applicability="Mandatory",
            applicability_note="Required for any VAT-registered entity in Lithuania.",
        ),
        FintechFiling(
            s_no=0,
            category="Indirect Tax",
        ...
        FintechFiling(
            ...
            form_name="PLN204 (+ annexes)",
            authority="VMI",
            frequency="Annual",
            due_date_rule="By the 15th day of the 6th month after the end of the tax period.",
            applicability="Mandatory",
        ),
        FintechFiling(
            s_no=0,
